...
This folder defines all source code for the 'Amazon Transformations' pipeline:
...
* Take a look at the sample under "sample_users_amazon_transformations.py" to get familiar with the syntax.
